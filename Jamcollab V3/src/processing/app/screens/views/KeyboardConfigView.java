...
public class KeyboardConfigView extends View {

	GCheckbox WordsTypedToggle; 
	GCheckbox WordsMinuteToggle; 
	GCheckbox KeysTypedToggle; 
	...
	public void Start() {
		...
		AddLabel(48, 32, 504, 20, "Estatísticas de Teclado", GAlign.LEFT, GAlign.MIDDLE, true);
		AddLabel(64, 88, 192, 16, "Palavras digitadas", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(64, 112, 192, 16, "Palavras por minuto", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(64, 136, 192, 16, "Teclas digitadas", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(64, 160, 192, 16, "Teclas por minuto", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(100, 200, 400, 50, "ATENÇÃO! Para sua segurança desabilite sempre ao digitar senhas", GAlign.CENTER, GAlign.MIDDLE, false);
	...
	public void Awake(boolean state) {
		WordsTypedToggle.setVisible(isActive());
		WordsMinuteToggle.setVisible(isActive());
		KeysTypedToggle.setVisible(isActive());
		KeysMinuteToggle.setVisible(isActive());
