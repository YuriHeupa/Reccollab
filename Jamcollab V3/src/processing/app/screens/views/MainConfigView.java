...
public class MainConfigView extends View {
	...
	static GImageToggleButton MicToggleButton; 
	...
	public void Start() {
		...
		AddLabel(280, 310, 270, 20, "Você está conectado como:", true, GCScheme.GREEN_SCHEME);
		
		User = AddLabel(320, 330, 180, 20, Utils.AppDAO.getStringData("USERNAME", ""), true);
		...
		Title2 = new GLabel(Application.app, 48, 232, 504, 20);
		...
		Option4Label = new GLabel(Application.app, 64, 160, 192, 16);
		...
		Option5Label = new GLabel(Application.app, 64, 184, 192, 16);
		Option5Label.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
		Option5Label.setText("Microfone");
		Option5Label.setOpaque(false);
		Option5Label.setVisible(false);
		Option6Label = new GLabel(Application.app, 64, 272, 192, 16);
		...
		Option7Label = new GLabel(Application.app, 64, 296, 192, 16);
		...
		ScreenshotButtonConfig = new GButton(Application.app, 288, 88, 80, 16);
		...
		FilechangeConfigButton = new GButton(Application.app, 288, 272, 80, 16);
		...
		HotkeysConfigButton = new GButton(Application.app, 288, 160, 80, 16);
		...
		MouseConfigButton = new GButton(Application.app, 288, 136, 80, 16);
		...
		WebcamConfigButton = new GButton(Application.app, 288, 112, 80, 16);
		...
		MicConfigButton = new GButton(Application.app, 288, 184, 80, 16);
		MicConfigButton.setText("Configurar");
		MicConfigButton.setLocalColorScheme(GCScheme.ORANGE_SCHEME);
		MicConfigButton.addEventHandler(this, "MicConfigButtonClicked");
		MicConfigButton.setVisible(false);
		ScreenshotToggleButton = new GImageToggleButton(Application.app, 262, 86, "resources/sprites/toggleonoff.png", 2, 1);
		...
		MicToggleButton = new GImageToggleButton(Application.app, 262, 182, "resources/sprites/toggleonoff.png", 2, 1);
		MicToggleButton.addEventHandler(this, "MicToggleButtonClick");
		MicToggleButton.setVisible(false);
		MicToggleButton.stateValue(Utils.AppDAO.getIntData("MIC_TOGGLE", 0));
		HotkeysToggleButton = new GImageToggleButton(Application.app, 262, 158, "resources/sprites/toggleonoff.png", 2, 1);
		...
		MouseToggleButton = new GImageToggleButton(Application.app, 262, 134, "resources/sprites/toggleonoff.png", 2, 1);
		...
		WebcamToggleButton = new GImageToggleButton(Application.app, 262, 110, "resources/sprites/toggleonoff.png", 2, 1);
		...
		ProcessToggleButton = new GImageToggleButton(Application.app, 262, 294, "resources/sprites/toggleonoff.png", 2, 1);
		...
		FilechangeToggleButton = new GImageToggleButton(Application.app, 262, 270, "resources/sprites/toggleonoff.png", 2, 1);
	...
	public void Awake(boolean state) {
		...
		Title2.setVisible(isActive());
		Option1Label.setVisible(isActive());
		Option2Label.setVisible(isActive());
		Option3Label.setVisible(isActive());
		Option4Label.setVisible(isActive());
		Option5Label.setVisible(isActive());
		Option6Label.setVisible(isActive());
		Option7Label.setVisible(isActive());
		ScreenshotButtonConfig.setVisible(isActive());
		FilechangeConfigButton.setVisible(isActive());
		HotkeysConfigButton.setVisible(isActive());
		MouseConfigButton.setVisible(isActive());
		WebcamConfigButton.setVisible(isActive());
		MicConfigButton.setVisible(isActive());
		ScreenshotToggleButton.setVisible(isActive());
		ProcessToggleButton.setVisible(isActive());
		FilechangeToggleButton.setVisible(isActive());
		MicToggleButton.setVisible(isActive());
		HotkeysToggleButton.setVisible(isActive());
		MouseToggleButton.setVisible(isActive());
		WebcamToggleButton.setVisible(isActive());
	}
	...
	public void MicConfigButtonClicked(GButton source, GEvent event) { 
		ViewHandler.Enable("MicConfig");
	}
	...
	public void MicToggleButtonClick(GImageToggleButton source, GEvent event) { 
		Utils.AppDAO.updateData("MIC_TOGGLE", String.valueOf(source.stateValue()));
		AudioHandler.SetActive(String.valueOf(source.stateValue()).equals("0") ? false : true);
	} 
	...
	public void Update() {
		...
		} else if(MicToggleButton.isTooltip()) {
			switch (MicToggleButton.stateValue()) {
			case 0:
				TooltipHandler.Show(new Vector2D(273, 182), "Desligado");
				break;
			case 1:
				TooltipHandler.Show(new Vector2D(273, 182), "Ligado");
				break;
			}
