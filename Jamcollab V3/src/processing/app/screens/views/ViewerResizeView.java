...
public class ViewerResizeView extends View {
	...
	public void Start() {
		...
		AddLabel(48, 32, 504, 20, "Redimensionar", GAlign.LEFT, GAlign.MIDDLE, true);
		...
		AddLabel(4, 136, 192, 16, "Largura:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 160, 192, 16, "Altura:", GAlign.RIGHT, GAlign.MIDDLE, false);
		...
		WidthInput = AddTextField(196, 136, 46, 16, G4P.SCROLLBARS_NONE);
		HeightInput = AddTextField(196, 160, 46, 16, G4P.SCROLLBARS_NONE);
		...
		AddButton(470, 32, 100, 24, "Redimensionar", GCScheme.SCHEME_15, 
