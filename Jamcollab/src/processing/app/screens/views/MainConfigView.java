...
public class MainConfigView extends View {
	...
	public void Start() {
		...
		Title2 = new GLabel(Application.app, 48, 222, 504, 20);
		...
		Option6Label = new GLabel(Application.app, 64, 262, 192, 16);
		...
		Option7Label = new GLabel(Application.app, 64, 286, 192, 16);
		...
		FilechangeConfigButton = new GButton(Application.app, 288, 262, 80, 16);
		...
		ProcessToggleButton = new GImageToggleButton(Application.app, 262, 284, "resources/sprites/toggleonoff.png", 2, 1);
		...
		FilechangeToggleButton = new GImageToggleButton(Application.app, 262, 260, "resources/sprites/toggleonoff.png", 2, 1);
