...
public class KeyboardStaticsView extends View {
	...
	public void Awake(boolean state) {
		...
		SubOptionLabel6.setVisible(isActive()); 
		SubOption1Text.setVisible(isActive()); 
		SubOption2Text.setVisible(isActive()); 
		SubOption4Text.setVisible(isActive()); 
		SubOption3Text.setVisible(isActive()); 
