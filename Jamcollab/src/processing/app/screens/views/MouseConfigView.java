...
public class MouseConfigView extends View {

	GLabel Title; 
	GLabel Option1Label; 
	GTextField CaptureTimeInput; 
	GCheckbox SaveMouseClicksToggle; 
	GLabel Option2Label; 
	GButton BackButton; 
	GButton SaveButton; 

	public MouseConfigView() {
		super();
	}
	...
	public void Awake(boolean state) {
		...
		SaveMouseClicksToggle.setVisible(isActive());
