...
public class ViewerVideoView extends View {
	...
	public void Start() {
		...
		AddLabel(48, 32, 504, 20, "Video", GAlign.LEFT, GAlign.MIDDLE, true);
		AddLabel(4, 88, 192, 16, "Imagens:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 112, 192, 16, "Destino:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 136, 192, 16, "Formato:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 160, 192, 16, "Codec:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 184, 192, 16, "Frame rate:", GAlign.RIGHT, GAlign.MIDDLE, false);

		MainImagePathInput = AddTextField(196, 88, 216, 16, G4P.SCROLLBARS_NONE);
		MainImagePathInput.setEnabled(false);
		OutputPathInput = AddTextField(196, 112, 216, 16, G4P.SCROLLBARS_NONE);
		OutputPathInput.setEnabled(false);

		FrameRateInput = AddTextField(196, 184, 26, 16, G4P.SCROLLBARS_NONE);
		FrameRateInput.setText("25");


		AddButton(420, 88, 76, 16, "Procurar", GCScheme.SCHEME_15, this, 
				"SearchMainImagePathButtonClick", "resources/sprites/folderIcon.png", 
				1, GAlign.RIGHT, GAlign.MIDDLE);
		AddButton(420, 112, 76, 16, "Procurar", GCScheme.SCHEME_15, this, 
				"SearchOutputPathButtonClick", "resources/sprites/folderIcon.png", 
				1, GAlign.RIGHT, GAlign.MIDDLE);
		AddButton(480, 32, 80, 24, "Gerar", GCScheme.SCHEME_15, 
				this, "GenerateButtonClicked");

		CodecSelectionList = AddDropList(196, 160, 216, 80, 4, 
				GCScheme.SCHEME_8, Encoder.codecList(), 3);

		FormatSelectionList = AddDropList(196, 136, 216, 80, 4, 
