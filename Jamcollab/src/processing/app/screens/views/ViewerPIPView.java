...
public class ViewerPIPView extends View {
	...
	@Override
	public void Start() {
		AddLabel(48, 32, 504, 20, "PIP", GAlign.LEFT, GAlign.MIDDLE, true);

		AddLabel(4, 88, 192, 16, "Imagens:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 112, 192, 16, "PIP Imagens:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 136, 192, 16, "Destino:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 160, 192, 16, "Tamanho:", GAlign.RIGHT, GAlign.MIDDLE, false);
		AddLabel(4, 184, 192, 16, "Posição:", GAlign.RIGHT, GAlign.MIDDLE, false);
		...
		AddButton(420, 112, 76, 16, "Procurar", GCScheme.SCHEME_15, this, 
				...
				1, GAlign.RIGHT, GAlign.MIDDLE);
		AddButton(420, 136, 76, 16, "Procurar", GCScheme.SCHEME_15, this, 
	...
	protected void Awake(boolean state) {
		MainImagePathInput.setVisible(isVisible());
		PIPImagePathInput.setVisible(isVisible());
		OutputPathInput.setVisible(isVisible());
		SizeSelectionList.setVisible(isVisible());
		PositionSelectionList.setVisible(isVisible());
