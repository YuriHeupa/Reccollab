 ...
 * Releasing the button off the button face creates a RELEASED event. <br>
 * 
 * 
 * @author Peter Lager
 * 
...
public class GImageButton extends GAbstractControl {
	 ...
	 * @param p1
	 * @param fnames
	 *            an array of up to 3 image filenames to represent the
	 ...
	 *            off/over/down state of the button.
	 * @param fnameMask
	 *            the alpha mask filename or null if no mask
	 */
	public GImageButton(PApplet theApplet, float p0, float p1, String[] fnames,
			String fnameMask) {
	...
	public GImageButton(PApplet theApplet, float p0, float p1, float p2,
		...
		if (mask != null) { // if we have a mask use it for the hot spot
			...
			hotspots = new HotSpot[] { new HSalpha(1, 0, 0, bimage[0],
					PApplet.CORNER) };
		}
		// ========================================================================
