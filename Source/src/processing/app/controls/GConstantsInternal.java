...
interface GConstantsInternal {
    ...
    int[][] grid = new int[][]{{I_NONE, I_TL, I_CL, I_COVERED, I_COVERED},
    ...
    int CLIP_RUN = 512;
    int COMBI_MODES = 768;
    // Basic strokes needed when using the Graphics2D object for drawing on the
    // buffer
    BasicStroke pen_1_0 = new BasicStroke(1, BasicStroke.CAP_ROUND,
            BasicStroke.JOIN_ROUND);
    BasicStroke pen_2_0 = new BasicStroke(2, BasicStroke.CAP_ROUND,
            BasicStroke.JOIN_ROUND);
    BasicStroke pen_3_0 = new BasicStroke(3, BasicStroke.CAP_ROUND,
            BasicStroke.JOIN_ROUND);
    BasicStroke pen_4_0 = new BasicStroke(4, BasicStroke.CAP_ROUND,
            BasicStroke.JOIN_ROUND);
