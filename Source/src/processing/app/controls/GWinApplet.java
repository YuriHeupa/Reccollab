 ...
 * 
 * This class extends PApplet and provides a drawing surface for the GWindow
 * class. Do not instantiate objects of this class, create GWindow objects
 * instead.
 * 
 * The event handling methods here are NOT called by Processing directly.
 * Instead events are caught by the GWindowInfo class which then call the
 * appropriate method this class. <br>
 * These methods use reflection to execute methods registered by the GWindo
 * object that owns this class.
 * 
 * @author Peter Lager
 */
...
public class GWinApplet extends PApplet implements GConstants,
	...
	public void draw() {
		...
		if (owner.drawHandlerObject != null) {
			try {
				owner.drawHandlerMethod.invoke(owner.drawHandlerObject,
						new Object[] { this, owner.data });
			} catch (Exception e) {
				GMessenger.message(EXCP_IN_HANDLER,
						new Object[] { owner.drawHandlerObject,
								owner.drawHandlerMethodName, e });
			}
		}
	}
	...
	public void mouseEvent(MouseEvent event) {
		if (owner.mouseHandlerObject != null) {
			try {
				owner.mouseHandlerMethod.invoke(owner.mouseHandlerObject,
						new Object[] { this, owner.data, event });
			} catch (Exception e) {
				GMessenger.message(EXCP_IN_HANDLER, new Object[] {
						owner.mouseHandlerObject, owner.mouseHandlerMethodName,
						e });
			}
		}
	}
	...
	public void keyEvent(KeyEvent event) {
		if (owner.keyHandlerObject != null) {
			try {
				owner.keyHandlerMethod.invoke(owner.keyHandlerObject,
						new Object[] { this, owner.data, event });
			} catch (Exception e) {
				GMessenger
						.message(EXCP_IN_HANDLER, new Object[] {
								owner.keyHandlerObject,
								owner.keyHandlerMethodName, e });
			}
		}
	}
	...
	public void pre() {
		if (owner.preHandlerObject != null) {
			try {
				...
				GMessenger
						.message(EXCP_IN_HANDLER, new Object[] {
								owner.preHandlerObject,
								owner.preHandlerMethodName, e });
			}
		}
	}
	...
	public void post() {
		if (owner.postHandlerObject != null) {
			try {
				...
				GMessenger.message(EXCP_IN_HANDLER,
						new Object[] { owner.postHandlerObject,
								owner.postHandlerMethodName, e });
			}
		}
	}
