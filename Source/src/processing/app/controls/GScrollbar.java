...
class GScrollbar extends GAbstractControl {
    ...
    public GScrollbar(PApplet theApplet, float p0, float p1, float p2, float p3) {
        ...
        highCap = new RoundRectangle2D.Float(width - 15, 1, 14.5f, height - 2,
                6, 6);
    ...
    /**
     * Set the value and the thumb size. Force the value to be valid depending
     * on filler.
     *
    ...
    /**
     * Set the position of the thumb. If the value forces the thumb past the end
     * of the scrollbar, reduce the filler.
     *
     * @param value must be in the range 0.0 to 1.0
     */
    ...
    protected void updateBuffer() {
        if (bufferInvalid) {
            ...
            RoundRectangle2D thumb = new RoundRectangle2D.Float(1, 1,
                    thumbWidth - 1, height - 2, 6, 6);
