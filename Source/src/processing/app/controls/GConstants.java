...
public interface GConstants {
	...
	// Attribute:- fontface Value Type:- String font family name e.g.
	// "Times New Roman"
	...
	// Attribute:- font underline Value Type:- Float in range (0.0 to 0.20)
	TextAttribute UNDERLINE = TextAttribute.UNDERLINE;
	Integer UNDERLINE_ON = TextAttribute.UNDERLINE_ON;

	// Attribute:- font size Value Type:- Float
	TextAttribute SIZE = TextAttribute.SIZE;

	// Attribute:- font superscript Value Type:- Integer (1 : super or -1
	// subscript)
