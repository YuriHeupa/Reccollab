...
public abstract class GToggleControl extends GTextIconAlignBase {
	...
	public GToggleControl(PApplet theApplet, float p0, float p1, float p2,
			float p3) {
	...
	// toggle group
	// enforces single option selection from the group. Override this with an
	// empty method
	...
	/**
	 * Get the toggle group. If null is returned then it is not part of the
	 * group.
	 */
