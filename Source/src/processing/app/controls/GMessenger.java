...
class GMessenger implements GConstants, GConstantsInternal {
	...
	// GMessenger.message(, this, new Object[] {methodName, param_classes,
	// param_names});

	/**
	 * Unable to find the default handler method.
	 * 
	 * info[0] event generator class info[1] event handling method name info[2]
	 * the parameter class names info[3] the parameter names (identifiers)
	 * 
	 * @param event_generator
	 *            the object creating the events
	 * @param info
	...
	private static void missingEventHandler(Object[] info) {
		...
		output.append("You might want to add a method to handle " + className
				+ " events syntax is\n");
	 ...
	 * 
	 * @param obj1
	 *            the object generating the method
	 * @param obj2
	 *            the method name
	 * @param obj3
