...
public class GWindow extends Frame implements GConstants, GConstantsInternal {
     ...
     * @param w         width of the drawing area (the frame will be bigger to
     *                  accommodate border)
     * @param h         height of the drawing area (the frame will be bigger to
    ...
    public void setOnTop(boolean onTop) {
        try {
            ...
            if (G4P.showMessages)
                System.out
                        .println("Warning: setOnTop() method will not work when the sketch is run from a remote " +
                                "location.");
        }
    }
