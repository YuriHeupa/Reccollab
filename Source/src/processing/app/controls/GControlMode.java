...
public enum GControlMode implements PConstants {
	...
	CORNER("X Y W H coordinates", "CORNER", PApplet.CORNER), CORNERS(
			"X0 Y0 X1 Y1 coordinates", "CORNERS", PApplet.CORNERS), CENTER(
			"X Y W H coordinates", "CENTER", PApplet.CENTER);
