...
public class GTimer implements GConstantsInternal {
	 ...
	 * 
	 * @param theApplet
	 *            a reference to the PApplet object (invariably <b>this</b>)
	 * @param obj
	 *            the object that has the method to be executed (likely to be
	 *            <b>this</b>)
	 * @param methodName
	 *            the name of the method to be called by the timer
	 * @param delay
	 *            the initial delay and the time (in millisecs) between function
	 *            calls
	 */
	...
	/**
	 * See if 'obj' has a method called 'methodName' that has a single parameter
	 * of type GTimer and if so keep a reference to it.
	 * 
	 * @param obj
	 * @param methodName
	 */
	...
	protected void fireEvent() {
		if (eventHandlerMethod != null) {
			try {
				...
				System.out.println("Disabling " + eventHandlerMethod.getName()
	 ...
	 * nrepeats If nrepeats is <=0 then repeat forever
	 * 
	 * @param nrepeats
	 */
	 ...
	 * 
	 * @param delay
	 *            initial delay and interval in milliseconds
	 */
	 ...
	 * 
	 * @return initial delay in millsecs or -1 if the timer failed to be
	 *         created.
	 */
