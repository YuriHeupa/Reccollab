...
public class GStick extends GAbstractControl {
	...
	protected static final int[] posMap = new int[] { 0x01, 0x07, 0x04, 0x1c,
			0x10, 0x70, 0x40, 0xc1 };
	...
	public GStick(PApplet theApplet, float p0, float p1, float p2, float p3) {
		...
		createEventHandler(G4P.sketchApplet, "handleStickEvents",
				new Class<?>[] { GStick.class, GEvent.class }, new String[] {
						"stick", "event" });
	 ...
	 * If the mode parameter should be either G4P.X4 or G4P.X8 any other value
