...
public class FilechangeStatics extends BaseObject {
    ...
    public void Awake() {
        ...
        SubOptionLabel5 = new GLabel(Reccollab.app, 64, 176, 136, 16);
        ...
        CreatedText = new GLabel(Reccollab.app, 208, 112, 80, 16);
        ...
        ModifiedText = new GLabel(Reccollab.app, 208, 128, 80, 16);
        ...
        DeletedText = new GLabel(Reccollab.app, 208, 144, 80, 16);
        ...
        DataSizeText = new GLabel(Reccollab.app, 208, 160, 80, 16);
        ...
        FolderText = new GLabel(Reccollab.app, 208, 176, 350, 16);
    ...
    public void Mouse(MouseEvent e) {
        if (e.getAction() == MouseEvent.RELEASE) {
            if (Reccollab.app.mouseButton == PConstants.LEFT)
