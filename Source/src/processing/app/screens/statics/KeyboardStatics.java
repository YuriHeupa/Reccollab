...
public class KeyboardStatics extends BaseObject {
    ...
    public void Awake() {
        ...
        SubOptionLabel2 = new GLabel(Reccollab.app, 64, 120, 136, 16);
        ...
        SubOptionLabel3 = new GLabel(Reccollab.app, 64, 216, 136, 16);
        ...
        SubOptionLabel4 = new GLabel(Reccollab.app, 64, 232, 136, 16);
        ...
        SubOption1Text = new GLabel(Reccollab.app, 208, 104, 80, 16);
        ...
        SubOption3Text = new GLabel(Reccollab.app, 208, 216, 80, 16);
        ...
        SubOption2Text = new GTextArea(Reccollab.app, 204, 120, 350, 88, G4P.SCROLLBARS_NONE);
        SubOption2Text.setOpaque(true);
        SubOption2Text.setVisible(false);
        SubOption2Text.setEnabled(false);
        SubOption4Text = new GTextArea(Reccollab.app, 204, 232, 350, 88, G4P.SCROLLBARS_NONE);
        SubOption4Text.setOpaque(true);
        SubOption4Text.setVisible(false);
        SubOption4Text.setEnabled(false);

        SubOptionLabel5 = new GLabel(Reccollab.app, 200, 104, 136, 16);
        ...
        SubOptionLabel6 = new GLabel(Reccollab.app, 200, 216, 136, 16);
        ...
        WordsMinuteTypedNumber = new GLabel(Reccollab.app, 340, 104, 80, 16);
        ...
        KeysMinuteTypedNumber = new GLabel(Reccollab.app, 340, 216, 80, 16);
