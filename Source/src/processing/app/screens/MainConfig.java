...
public class MainConfig extends BaseObject {
    ...
    public void Awake() {
        ...
        if (Utils.AppDAO.getBooleanData("NEED_HELP", true)) {
            helpImage = Reccollab.app.loadImage(Assets.HELP_IMAGE);
        }
        ...
        ScreenshotToggle = new GImageToggleButton(Reccollab.app, 262, 136, "resources/sprites/toggleonoff.png", 2, 1);
        ...
        WebcamToggle = new GImageToggleButton(Reccollab.app, 262, 160, "resources/sprites/toggleonoff.png", 2, 1);
        ...
        MouseToggle = new GImageToggleButton(Reccollab.app, 262, 182, "resources/sprites/toggleonoff.png", 2, 1);
        ...
        KeyboardToggle = new GImageToggleButton(Reccollab.app, 262, 208, "resources/sprites/toggleonoff.png", 2, 1);
        ...
        FilesToggle = new GImageToggleButton(Reccollab.app, 262, 310, "resources/sprites/toggleonoff.png", 2, 1);
        ...
        ProcessToggle = new GImageToggleButton(Reccollab.app, 262, 334, "resources/sprites/toggleonoff.png", 2, 1);
    ...
    public void ImportButton(GButton source, GEvent event) {
        Reccollab.app.selectInput(Lang.SELECT_EXPORT_FOLDER, "selectImportFile", null, this);
    }
    ...
    public void ExportButton(GButton source, GEvent event) {
        if (zipThread != null) {
            if (zipThread.isAlive()) {
                ...
                loadingZipDialog.setLocationRelativeTo(Reccollab.jframe);
                return;
            }
        }
        Reccollab.app.selectFolder(Lang.SELECT_EXPORT_FOLDER, "selectExportFolder", null, this);
    }
    ...
    public void Update() {
        ...
        if (view.isVisible()) {
            if (helpImage != null) {
                Reccollab.app.image(helpImage, 0, 0);
                Reccollab.app.fill(248, 248, 248);
                Reccollab.app.textSize(16);
                Reccollab.app.text(Lang.CLICK_ANYWHERE, 300, 96);
            }
