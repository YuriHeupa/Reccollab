...
public class Home extends BaseObject {
    ...
    public void Awake() {
        ...
        GDropList langSelector = view.AddDropList(402, 22, 160, 80, 4, GCScheme.SCHEME_8, Lang.avaiableLangs(), 0,
                this, "LanguageChanged");
        langSelector.setSelected(Utils.AppDAO.getIntData("LANGUAGE", 0));

        //view.AddButton(160, 240, 120, 30, "Trocar usu�rio", this, "ButtonChangeUserClicked");
