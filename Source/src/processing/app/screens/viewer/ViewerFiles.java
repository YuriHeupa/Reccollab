...
public class ViewerFiles extends BaseObject {
	...
	@Override
	public void Init() {
		view.AddLabel(48, 32, 504, 20, "Arquivos", GAlign.LEFT, GAlign.MIDDLE, true);

		view.AddLabel(4, 88, 192, 16, "Logs de arquivos:", GAlign.RIGHT, GAlign.MIDDLE, false);
