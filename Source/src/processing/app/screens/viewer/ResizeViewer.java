    ...
    public void ResizeButtonClicked(GButton source, GEvent event) {
        ...
        if (resizeThread != null) {
            if (resizeThread.isAlive()) {
                ...
                resizeDialog.setLocationRelativeTo(Reccollab.jframe);
                return;
            }
        }
