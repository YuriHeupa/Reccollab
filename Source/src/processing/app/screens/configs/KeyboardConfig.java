...
public class KeyboardConfig extends BaseObject {
    ...
    public void Awake() {
        ...
        WordsTypedToggle = new GCheckbox(Reccollab.app, 256, 88 + y, 24, 20);
        ...
        WordsMinuteToggle = new GCheckbox(Reccollab.app, 256, 112 + y, 24, 20);
        ...
        KeysTypedToggle = new GCheckbox(Reccollab.app, 256, 136 + y, 24, 20);
        ...
        KeysMinuteToggle = new GCheckbox(Reccollab.app, 256, 160 + y, 24, 20);
