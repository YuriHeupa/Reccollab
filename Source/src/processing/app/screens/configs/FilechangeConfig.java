...
public class FilechangeConfig extends BaseObject {
    ...
    public void Awake() {
        ...
        Option1Label = new GLabel(Reccollab.app, 64, 88 + y, 192, 16);
        ...
        WatchFolderInput = new GTextField(Reccollab.app, 256, 88 + y, 216, 16, G4P.SCROLLBARS_NONE);
        ...
        SearchPathButton1 = new GButton(Reccollab.app, 480, 88 + y, 76, 16);
        ...
        LogFolderInput = new GTextField(Reccollab.app, 256, 112 + y, 216, 16, G4P.SCROLLBARS_NONE);
        ...
        SearchPathButton2 = new GButton(Reccollab.app, 480, 112 + y, 76, 16);
    ...
    public void SearchWatchPathButtonClick(GButton source, GEvent event) {
        Reccollab.app.selectFolder(Lang.SELECT_WATCH_FOLDER, "selectWatchFolder", null, this);
    }
    ...
    public void SearchLogPathButtonClick(GButton source, GEvent event) {
        Reccollab.app.selectFolder(Lang.SELECT_SAVE_FOLDER, "selectLogFolder", null, this);
    }
