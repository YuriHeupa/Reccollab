...
public class Assets {
    ...
    public static void loadResources() {
        mapPIN = ImageManager.loadImage(Reccollab.app, "./resources/maps/MapPin.png");
        //mapPIN = Application.app.loadImage("./resources/maps/MapPin.png");
        zoomIn = Reccollab.app.loadImage("./resources/maps/ZoomIn.png");
        zoomOut = Reccollab.app.loadImage("./resources/maps/ZoomOut.png");
